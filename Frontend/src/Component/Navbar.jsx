...
export default function Navbar({ onSearchClick,onNotificationClick }) {
  return (
        ...
        <button onClick={onNotificationClick} className="relative hover:text-[#00a884] transition-colors" title="Notifications">
         <div  >
          ...
          {/* Notification Badge / Dot */}
            ...
            <span className="absolute -top-0.5 -right-0.5 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-[#00a884] text-[10px] font-bold text-[#111b21]">
              {1}
            </span>
          </div> 
        </button>
